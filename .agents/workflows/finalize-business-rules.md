...
* Tài liệu Use Cases ([use-case-overview.md](file:///d:/projects/dss-ai-Purchase-wolf205/docs/business/use-case-overview.md) và các file chi tiết [uc-01](file:///d:/projects/dss-ai-Purchase-wolf205/docs/business/use-cases/uc-01-review-approve-recommendations.md) đến [uc-04](file:///d:/projects/dss-ai-Purchase-wolf205/docs/business/use-cases/uc-04-import-operational-data.md)) đã hoàn thành.
* Các quy tắc nghiệp vụ (BR-01 đến BR-16) đã được thảo luận và làm rõ công thức, tham số và cơ chế dự phòng.
...
* **Nhóm 1 (Nhu cầu & Tồn kho):** BR-01 (Công thức ROP, Safety Stock $Z \times \sigma_d \times \sqrt{L}$, SOQ), BR-05 (Phân loại ABC theo doanh thu, XYZ theo $CV$).
* **Nhóm 2 (Đánh giá Nhà cung cấp):** BR-02 (Mô hình WSM 4 tiêu chí: Giá, Lead Time, Lịch sử OTIF, MOQ), BR-13 (Cập nhật điểm OTIF sau nhận hàng).
...
* **Nhóm 5 (Toàn vẹn Dữ liệu):** BR-14 (Cơ chế All-or-Nothing), BR-15 (Khử trùng & ghi đè doanh số), BR-16 (Thay thế snapshot tồn kho).
* **Cơ chế Fallback:** Quy tắc tính toán khi SKU mới hoặc NCC mới thiếu dữ liệu.
* **Tham số cấu hình hệ thống:** Service Level $Z$-score, Trọng số WSM, Ngưỡng cảnh báo.
...
1. Danh sách 16 quy tắc nghiệp vụ chuẩn hóa (BR-01 đến BR-16).
...
Tài liệu phải tuân thủ chuẩn cấu trúc đặc tả tại [.agents/skills/business-rules-analysis/references/rule-specification-template.md](file:///d:/projects/dss-ai-Purchase-wolf205/.agents/skills/business-rules-analysis/references/rule-specification-template.md).
